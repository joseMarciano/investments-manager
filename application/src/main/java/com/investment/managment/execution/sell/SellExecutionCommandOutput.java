...
public record SellExecutionCommandOutput(
        ExecutionID id,
    ...
    public static SellExecutionCommandOutput from(final Execution anExecution) {
        return new SellExecutionCommandOutput(
                anExecution.getId(),
